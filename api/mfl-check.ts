...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    console.log("[Vercel /mfl-check] requestedModel:", model);
    console.log("[Vercel /mfl-check] finalModelUsed:", finalModel);
    ...
    console.log("[Vercel /mfl-check] endpointUsed:", url.replace(apiKey, "HIDDEN_KEY"));
